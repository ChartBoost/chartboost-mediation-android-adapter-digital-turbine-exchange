...
curl -sSf -u "$JFROG_USER:$JFROG_PASS" -O 'https://cboost.jfrog.io/artifactory/private-helium/com/chartboost/helium-adapter-digital-turbine-exchange/maven-metadata.xml'
