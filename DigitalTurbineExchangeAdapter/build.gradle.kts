...
android {
    namespace = "com.chartboost.helium.digitalturbineexchangeadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.8.2.1.0"
        buildConfigField("String", "HELIUM_DIGITAL_TURBINE_EXCHANGE_ADAPTER_VERSION", "\"${android.defaultConfig.versionName}\"")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("DigitalTurbineExchangeAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                var adapterName = "digital-turbine-exchange"
                ...
                pom {
                    name.set("Helium Adapter Digital Turbine Exchange")
